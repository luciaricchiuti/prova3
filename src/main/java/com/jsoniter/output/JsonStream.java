...
public class JsonStream extends OutputStream {
    ...
    public final void writeTrue() throws IOException {
    	...
    	Character c3 = 'u';
    	Character c4 = 'e';
        write(c1.toString().getBytes()[0], c2.toString().getBytes()[0], c3.toString().getBytes()[0], c3.toString().getBytes()[0], c4.toString().getBytes()[0]);
    }
    ...
    public final void writeFalse() throws IOException {
    	...
    	Character c4 = 's';
    	Character c5 = 'e';
        write(c1.toString().getBytes()[0], c2.toString().getBytes()[0], c3.toString().getBytes()[0], c3.toString().getBytes()[0], c4.toString().getBytes()[0], c5.toString().getBytes()[0]);
    }
    ...
    public final void writeVal(short val) throws IOException {
        writeVal(Short.valueOf(val).intValue()); 
    ...
    public final void writeNull() throws IOException {
    	...
    	Character c2 ='u';
    	Character c3 = 'l';
        write(c1.toString().getBytes()[0], c2.toString().getBytes()[0], c3.toString().getBytes()[0], c3.toString().getBytes()[0]);
    }

    public final void writeEmptyObject() throws IOException {
    	Character c1 = '{';
    	Character c2 ='}';
        write(c1.toString().getBytes()[0], c2.toString().getBytes()[0]);
    }
    ...
    public final void writeObjectField(String field) throws IOException {
        ...
        if (indention > 0) {
        	Character temp = ':';
        	Character temp1 = ' ';
            write(temp.toString().getBytes()[0], temp1.toString().getBytes()[0]);
        } else {
            write(':');
        }
    }
